...
private:
	...
	void executeCastling(int fromRow, int fromCol,
		int toRow, int toCol);
	bool isCastlingMove(int fromRow, int fromCol,
		int toRow, int toCol) const;

	void executeEnPassant(int fromRow, int fromCol,
		int toRow, int toCol);
	bool isEnPassantMove(int fromRow, int fromCol,
		int toRow, int toCol) const;
...
public:
	...
	// Sets up names for both players
	void setup();

	// Main game loop — runs until checkmate or stalemate
	void run();
};
